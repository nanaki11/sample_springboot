...
public class GetFacilityFavoriteControllerTest {
	...
	// 試験対象の設定
	private static final String path = "/api/favorite/facility/getlist";
	@InjectMocks
	private GetFacilityFavoriteController controller;
	@MockBean
	 ...
	 */
	private String setupApiTest(MultiValueMap<String, String> params, List<FacilityFavorite> favorites) throws JsonProcessingException {
	...
	public void main_success_test1() throws Exception {
		...
		// 取得データ
		List<FacilityFavorite> favorites = new ArrayList<>();

		// 試験パラメータの設定
		MultiValueMap<String, String> params = new LinkedMultiValueMap<String, String>();
		params.add("clientId", ApiResponseUtil.CLIENT_ID);
		params.add("customerId", customerId);
		String apiResponse = setupApiTest(params, favorites);

		// 取得データのモック処理
		when(service.findByCustomerId(anyLong())).thenReturn(favorites);
		...
		verify(this.service, times(1)).findByCustomerId(anyLong());
	}
	...
	public void main_success_test2() throws Exception {
		...
		// 取得データ
		List<FacilityFavorite> favorites = new ArrayList<>();
		FacilityFavorite facilityFavorite1 = new FacilityFavorite();
		facilityFavorite1.setCustomerId(Long.valueOf(customerId));
		facilityFavorite1.setBusinessCd("1");
		favorites.add(facilityFavorite1);
		FacilityFavorite facilityFavorite2 = new FacilityFavorite();
		facilityFavorite2.setCustomerId(Long.valueOf(customerId));
		facilityFavorite2.setBusinessCd("2");
		favorites.add(facilityFavorite2);
	...
	public void validationCheck_test6()
		...
		assertEquals(true, (res.getId().matches("^[0-9]{18}_[0-9a-zA-Z]{4}$")));
		assertEquals(ApiResponseUtil.ERROR_CODE_F004001, res.getCode());
