...
public class GetContentFavoriteControllerTest {
	...
	// 試験対象の設定
	private static final String path = "/api/favorite/content/getlist";
	@InjectMocks
	private GetContentFavoriteController controller;
	@MockBean
	 ...
	 */
	private String setupApiTest(MultiValueMap<String, String> params, List<ContentFavorite> favorites) throws JsonProcessingException {
	...
	public void main_success_test1() throws Exception {
		...
		// 取得データ
		List<ContentFavorite> favorites = new ArrayList<>();
	...
	public void main_success_test2() throws Exception {
		...
		// 取得データ
		List<ContentFavorite> favorites = new ArrayList<>();
		ContentFavorite contentFavorite1 = new ContentFavorite();
		contentFavorite1.setCustomerId(Long.valueOf(customerId));
		contentFavorite1.setContentId(1);
		favorites.add(contentFavorite1);
		ContentFavorite contentFavorite2 = new ContentFavorite();
		contentFavorite2.setCustomerId(Long.valueOf(customerId));
		contentFavorite2.setContentId(2);
		favorites.add(contentFavorite2);
	...
	public void validationCheck_test6()
		...
		assertEquals(true, (res.getId().matches("^[0-9]{18}_[0-9a-zA-Z]{4}$")));
		assertEquals(ApiResponseUtil.ERROR_CODE_F001001, res.getCode());
